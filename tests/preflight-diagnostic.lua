return function(test, equal, truthy)
    ...
    test("diagnostic error details are bounded allowlisted and retained after halt", function()
        ...
        for _, case in ipairs({
            ...
            { value = "Native probe data has an unexpected type", code = "probe-data-shape" },
            { value = "Native probe data changed during observation", code = "probe-data-changed" },
            { value = "Native probe table schema is unsupported", code = "probe-table-schema" },
            { value = "Native probe metadata is unsupported", code = "probe-metadata" },
            { value = "Native probe observer registration failed", code = "probe-hook-registration" },
