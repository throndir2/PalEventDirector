...
const required = [
  ...
  'tests/custom-assault.lua',
  'tests/custom-assault-native.lua',
  'tests/custom-assault-director.lua',
  'tests/startup-test.lua',
  'tests/placement-search.lua',
  'tests/surface-survey.lua',
  'tests/shape-qualification.lua',
  'tests/cadence-trial.lua',
